...
function seleccionarPokemonJugador() {
    ...
    let inputDragonite = document.getElementById('dragonite')
    let inputArcanine = document.getElementById('arcanine')
    ...
    if (inputCharmander.checked) {
        ...
        spanPokemonJugador.innerHTML = 'Dragonite'
    } else if (inputArcanine.checked) {
        spanPokemonJugador.innerHTML = 'Arcanine'
    } else { 
...
function seleccionarPokemonEnemigo() {
    ...
    if (mascotaAleatoria == 1) {
        ...
        spanMascotaEnemigo.innerHTML = 'Dragonite'
    } else {
        spanMascotaEnemigo.innerHTML = 'Arcanine'
    }
}
...
function combate() {
    ...
    if(ataqueEnemigo == ataqueJugador) {
        ...
        vidasEnemigo--
        spanVidasEnemigo.innerHTML = vidasEnemigo
    } else if(ataqueJugador == 'HIELO' && ataqueEnemigo == 'FUEGO') {
        crearMensaje("GANASTE")
        vidasEnemigo--
        spanVidasEnemigo.innerHTML = vidasEnemigo
    } else {
